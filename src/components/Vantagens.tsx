...
const Vantagens: React.FC<VantagensProps> = ({ vantagens }) => {
  return (
    <div>
      <Card className="relative -skew-x-3 bg-[#00fd90] shadow-[8px_8px_15px_rgba(0,0,0,0.3)] max-w-[420px] w-full transition duration-300 transform hover:scale-105 hover:z-10">
        <CardHeader>
